...
public class WriteMailClient extends MailClient {
	...
	public static void main(String[] args) {
        ...
        try {
            ...
            KeyStore userAKeystore = keystoreReader.readKeyStore("./data/userKeyStores/usera.jks", "123".toCharArray());
           ...
           byte[] byteMail = DataSignUtill.signDataEnveloped(subject, body, userBPublicKey, userAPrivKey);
			...
			Cipher tripleDesCipher = Cipher.getInstance("DESede/CBC/PKCS5Padding");
