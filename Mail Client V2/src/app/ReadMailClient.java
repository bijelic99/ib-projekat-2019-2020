...
public class ReadMailClient extends MailClient {
	...
	public static void main(String[] args) throws Exception {
		...
		Cipher aesCipherDec = Cipher.getInstance("DESede/CBC/PKCS5Padding");
		...
		KeyStore keyStoreUserB = keyReader.readKeyStore("./data/userKeyStores/userb.jks", "123".toCharArray());
		...
		Document doc = DataSignUtill.toXml(byteSignature);
		
		Element rootElement = doc.getDocumentElement();
		
		X509Certificate certA =keyReader.getXCertificateFromKeyStore(keyStoreUserB, "usera");
		
		System.out.println("Mail se poklapa sa signature-om: " + DataSignUtill.verify(doc, certA));
